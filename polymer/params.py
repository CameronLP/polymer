...
class Params(object):
    ...
    def sensor_specific(self, sensor, platform):
        ...
        elif sensor.startswith('HYPSO-1'):
            self.defaults_hypso1()
        elif sensor.startswith('HYPSO-2'):
            self.defaults_hypso2()
    ...
    def defaults_hypso1(self):

        sensor = self.sensor
        sensor = sensor.split("_")
        sensor_version = sensor[1]

        match sensor_version:

            case "original": # original radiometric coefficients and bands

                hypso_bands = [389, 393, 396, 400, 403, 407, 410, 414, 417, 421, 424, 428, 431, 435, 438, 442, 445, 449,
                                452, 456, 459, 463, 466, 470, 473, 477, 480, 484, 487, 491, 494, 498, 501, 505, 508, 512,
                                515, 519, 522, 526, 529, 533, 536, 540, 543, 547, 550, 554, 557, 561, 564, 567, 571, 574,
                                578, 581, 585, 588, 592, 595, 599, 602, 605, 609, 612, 616, 619, 623, 626, 630, 633, 637,
                                640, 643, 647, 650, 654, 657, 661, 664, 667, 671, 674, 678, 681, 685, 688, 691, 695, 698,
                                702, 705, 709, 712, 715, 719, 722, 726, 729, 732, 736, 739, 743, 746, 749, 753, 756, 760,
                                763, 766, 770, 773, 777, 780, 783, 787, 790, 794, 797, 800]

                hypso_bands_rw = [403, 407, 410, 414, 417, 421, 424, 428, 431, 435, 438, 442, 445, 449,
                                452, 456, 459, 463, 466, 470, 473, 477, 480, 484, 487, 491, 494, 498, 501, 505, 508, 512,
                                515, 519, 522, 526, 529, 533, 536, 540, 543, 547, 550, 554, 557, 561, 564, 567, 571, 574,
                                578, 581, 585, 588, 592, 595, 599, 602, 605, 609, 612, 616, 619, 623, 626, 630, 633, 637,
                                640, 643, 647, 650, 654, 657, 661, 664, 667, 671, 674, 678, 681, 685, 688, 691, 695, 698,
                                702, 705, 709, 712, 715, 719, 722, 726, 729, 732, 736, 739, 743, 746, 749, 753, 756, 760,
                                763, 766, 770, 773, 777, 780, 783, 787, 790]

                hypso_bands_corr = [452, 456, 459, 463, 466, 470, 473, 477, 480, 484, 487, 491, 494, 498, 501, 505, 508, 512,
                                515, 519, 522, 526, 529, 533, 536, 540, 543, 547, 550, 554, 557, 561, 564, 567, 571, 574,
                                578, 581, 585, 588, 592, 595, 599, 602, 605, 609, 612, 616, 619, 623, 626, 630, 633, 637,
                                640, 643, 647, 650, 654, 657, 661, 780, 783, 787, 790, 794, 797, 800]

                self.band_cloudmask = 794

            case "moved" | "adjusted": # updated radiometric coefficients and bands

                hypso_bands = [390, 394, 397, 401, 404, 408, 411, 415, 418, 422, 425, 429, 432,
                            436, 439, 443, 446, 450, 453, 457, 460, 464, 467, 471, 474, 478,
                            481, 485, 488, 492, 495, 499, 502, 506, 509, 513, 516, 520, 523,
                            527, 530, 534, 537, 541, 544, 548, 551, 555, 558, 562, 565, 568,
                            572, 575, 579, 582, 586, 589, 593, 596, 600, 603, 607, 610, 613,
                            617, 620, 624, 627, 631, 634, 638, 641, 644, 648, 651, 655, 658,
                            662, 665, 669, 672, 675, 679, 682, 686, 689, 693, 696, 699, 703,
                            706, 710, 713, 716, 720, 723, 727, 730, 734, 737, 740, 744, 747,
                            751, 754, 757, 761, 764, 768, 771, 774, 778, 781, 785, 788, 791,
                            795, 798, 802]

                hypso_bands_rw = [404, 408, 411, 415, 418, 422, 425, 429, 432,
                            436, 439, 443, 446, 450, 453, 457, 460, 464, 467, 471, 474, 478,
                            481, 485, 488, 492, 495, 499, 502, 506, 509, 513, 516, 520, 523,
                            527, 530, 534, 537, 541, 544, 548, 551, 555, 558, 562, 565, 568,
                            572, 575, 579, 582, 586, 589, 593, 596, 600, 603, 607, 610, 613,
                ...
                hypso_bands_corr = [453, 457, 460, 464, 467, 471, 474, 478,
                            481, 485, 488, 492, 495, 499, 502, 506, 509, 513, 516, 520, 523,
                            527, 530, 534, 537, 541, 544, 548, 551, 555, 558, 562, 565, 568,
                            572, 575, 579, 582, 586, 589, 593, 596, 600, 603, 607, 610, 613,
                            617, 620, 624, 627, 631, 634, 638, 641, 644, 648, 651, 655, 658,
                                778, 781, 785, 788, 791, 795, 798, 802]

                self.band_cloudmask = 791

            case _:
                print("No matching HYPSO bands found.")
    ...
    def defaults_hypso2(self):
        ...
        match sensor_version:
            ...
            case "moved" | "adjusted": # updated radiometric coefficients and bands
                ...
                hypso_bands = [378, 382, 385, 389, 392, 396, 399, 403, 406, 410, 413, 417, 420,
                                424, 427, 431, 434, 438, 441, 445, 448, 452, 455, 459, 462, 466,
                                469, 473, 476, 480, 483, 487, 490, 494, 497, 501, 504, 508, 511,
                                515, 518, 522, 525, 529, 532, 536, 539, 543, 546, 550, 553, 557,
                                560, 564, 567, 570, 574, 577, 581, 584, 588, 591, 595, 598, 602,
                                605, 608, 612, 615, 619, 622, 626, 629, 633, 636, 640, 643, 646,
                                650, 653, 657, 660, 664, 667, 670, 674, 677, 681, 684, 688, 691,
                                694, 698, 701, 705, 708, 712, 715, 718, 722, 725, 729, 732, 735,
                                739, 742, 746, 749, 752, 756, 759, 763, 766, 769, 773, 776, 780,
                                783, 786, 790]

                hypso_bands_rw = [403, 406, 410, 413, 417, 420,
                                424, 427, 431, 434, 438, 441, 445, 448, 452, 455, 459, 462, 466,
                                469, 473, 476, 480, 483, 487, 490, 494, 497, 501, 504, 508, 511,
                                515, 518, 522, 525, 529, 532, 536, 539, 543, 546, 550, 553, 557,
                                560, 564, 567, 570, 574, 577, 581, 584, 588, 591, 595, 598, 602,
                ...
                hypso_bands_corr = [448, 452, 455, 459, 462, 466,
                                469, 473, 476, 480, 483, 487, 490, 494, 497, 501, 504, 508, 511,
                                515, 518, 522, 525, 529, 532, 536, 539, 543, 546, 550, 553, 557,
                                560, 564, 567, 570, 574, 577, 581, 584, 588, 591, 595, 598, 602,
                                605, 608, 612, 615, 619, 622, 626, 629, 633, 636, 640, 643, 646,
                                650, 653, 657, 660, 780, 783, 786, 790]

                self.band_cloudmask = 790
